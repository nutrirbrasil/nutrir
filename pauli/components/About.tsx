...
export function About() {
  return (
    <section id="sobre" className="scroll-mt-20 bg-pauli-sand/60 px-4 py-20 dark:bg-[#151c19]">
      <div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-2">
        <div className="order-2 md:order-1">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-pauli-emerald/60">
            Sobre mim
          </p>
          <h2 className="mt-2 font-display text-3xl font-bold text-pauli-charcoal dark:text-pauli-sage md:text-4xl">
            {site.fullName}
          </h2>
          ...
          <p className="mt-6 leading-relaxed text-pauli-charcoal/80 dark:text-pauli-sage/80">{site.education}</p>

          <div className="mt-6 space-y-4 leading-relaxed text-pauli-charcoal/80 dark:text-pauli-sage/80">

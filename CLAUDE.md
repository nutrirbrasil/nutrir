...
**Nunca use travessão/em dash ("—") em nenhum texto, código, comentário ou commit, em nenhum dos três projetos.** Use vírgula ou ponto no lugar. Isso vale tanto para texto voltado ao usuário (UI, copy) quanto para comentários de código e documentação.

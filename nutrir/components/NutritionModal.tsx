  ...
  return createPortal(
    <>
      ...
      <div
        ...
        className="fixed left-1/2 top-1/2 z-[90] flex max-h-[min(90vh,640px)] w-[min(94vw,460px)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl bg-nutrir-canvas-alt shadow-2xl"
      >
        <div className="flex items-start justify-between gap-3 border-b border-nutrir-nude-dark/40 px-5 py-4">
          <div>
            <h2
              ...
              className="font-display text-lg font-bold text-nutrir-ink"
            >
              Tabela nutricional
            </h2>
